...
namespace PoeHUD.Poe
{
	public class Entity : RemoteMemoryObject
	{
        ...
        /// <summary>
        /// Druzil:
        /// Pointer to last entry of Component List
        /// </summary>
        private int ComponentListEnd
        {
            get
            {
        ...
        /// <summary>
        /// Druzil 
        /// Returns the Numer of Components without the need to Browse through the list
        /// </summary>
        private int NrOfComponents
        {
            get
            {
                return ComponentListEnd -  ComponentList /4;
            }
        }
