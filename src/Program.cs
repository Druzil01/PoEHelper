	...
	public class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			using (Memory memory = new Memory(offs, pid))
			{
				...
				try
				{
                    keyboard kb = new keyboard(gameController);
                    ...
                    //kb.AddKeyEvent((int)Keys.Control +Keys.F11, new KbEvent(KeyBoardEvents.SwitchDebugDisplay));
                    kb.AddKeyEvent(Keys.F12, new KbEvent(KeyBoardEvents.SwitchDebugDisplay));
